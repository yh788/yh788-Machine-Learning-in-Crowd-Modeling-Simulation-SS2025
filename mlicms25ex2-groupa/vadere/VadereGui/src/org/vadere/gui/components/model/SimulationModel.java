...
public abstract class SimulationModel<T extends DefaultSimulationConfig> extends DefaultModel {
	...
	public Color getGroupColor(@NotNull final  Pedestrian ped) {
		...
		return switch (groupId) {
			case 0 -> Color.RED;   	  // Infected
			case 1 -> Color.BLUE;     // Susceptible
			case 2 -> Color.GREEN;    // Recovered (for Task 5)
			default -> Color.GRAY;    // Default color if necessary (sanity check)
		};
	}
